...
import 'package:homework/widgets/popular_section.dart';
import 'package:homework/widgets/search_field.dart';
            ...
            children: [
              ...
              Wrap(
                children: [
                  ...
                  MyChipSection(title: "Captian america"),
                  const SizedBox(width: 20.0),
                  MyChipSection(title: "Captian Marvel"),
                  const SizedBox(width: 20.0),
              ...
              MyPopularSeciton(),
              MyTitles(title: "Recomindations for you"),
              MyPopularSeciton(),
            ],
          ),
        ),
...
class MyChipSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Chip(
      ...
      backgroundColor: const Color(0xff5a4bed).withOpacity(0.3),
